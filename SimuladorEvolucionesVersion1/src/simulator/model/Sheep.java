...
public class Sheep extends Animal {
	...
	public void update(double dt) {
		...
		if (this._state == State.NORMAL) {
			...
			if (this._danger_source == null
					|| (this._pos.minus(this._danger_source._pos).magnitude() < this._sight_range)) {
				this._danger_source = this._danger_strategy.select(this,
			...
			if (this._mate_target != null && (this._mate_target._state == State.DEAD
					|| this._pos.minus(this._mate_target._pos).magnitude() < this._sight_range)) {
			...
			if (this._mate_target == null) {
				...
				if (this._mate_target != null) {
					...
					this._energy += 20.0 * 1.2 * dt;
					this._desire += 40.0 * dt;
					if ((this._pos.minus(this._mate_target._pos)).magnitude() < 8.0) { // se puede ver si con lo del
																						// distance to iria bine
						this._desire = 0;
	...
	// Buscar animal emparejarse pedir al gestor de regiones lista de animales con
	// mismo codigo
	...
	/*
	 * @Override public State get_state() { return null; }
	 * 
	 * @Override public Vector2D get_position() { // TODO Auto-generated method stub
	 * return null; }
	 * 
	 * @Override public String get_genetic_code() { // TODO Auto-generated method
	 * stub return null; }
	 * 
	 * @Override public Diet get_diet() { // TODO Auto-generated method stub return
	 * null; }
	 * 
	 * @Override public double get_speed() { // TODO Auto-generated method stub
	 * return 0; }
	 * 
	 * @Override public double get_sight_range() { // TODO Auto-generated method
	 * stub return 0; }
	 * 
	 * @Override public double get_energy() { // TODO Auto-generated method stub
	 * return 0; }
	 * 
	 * @Override public double get_age() { // TODO Auto-generated method stub return
	 * 0; }
	 * 
	 * @Override public Vector2D get_destination() { // TODO Auto-generated method
	 * stub return null; }
	 * 
	 * @Override public boolean is_pregnant() { // TODO Auto-generated method stub
	 * return false; }
	 */
