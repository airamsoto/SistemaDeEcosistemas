...
public class Wolf extends Animal {
	...
	public void update(double dt) {
		...
		if (this._state == State.NORMAL) {
			...
			if (this._hunt_target == null || (this._hunt_target._state == State.DEAD || (this._pos.minus(this._hunt_target._pos).magnitude() < this._sight_range))) {
			...
			if (this._mate_target != null && (this._mate_target._state == State.DEAD)) {
				// falta hacer la comprobacio de que este dfuera del campo visual que la tengo arriba pero no se si esta bien
